...
public class Member_Helper {
    ...
    private static Member_Helper Memh;
     ...
     */
    public static Member_Helper getHelper() {
        /** Singleton檢查是否已經有MemberHelper物件，若無則new一個，若有則直接回傳 */
        if(Memh == null) Memh = new Member_Helper();
     ...
     */
    public boolean checkDuplicate(Member_ m){
     ...
     */
    public JSONObject create(Member_ m) {
        /** 記錄實際執行之SQL指令 */
        String exexcute_sql = "";
        /** 紀錄程式開始執行時間 */
        long start_time = System.nanoTime();
     ...
     */
    public JSONObject update(Member_ m) {
        /** 紀錄回傳之資料 */
        JSONArray jsa = new JSONArray();
        /** 記錄實際執行之SQL指令 */
        String exexcute_sql = "";
